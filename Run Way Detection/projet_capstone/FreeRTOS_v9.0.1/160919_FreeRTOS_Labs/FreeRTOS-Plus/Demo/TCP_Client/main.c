...
/* Runway detection */
#include "RunwayDetection/runway_detection.h"
...
*/
#define mainCREATE_UDP_CLI_TASKS					0 // 1
#define mainCREATE_TCP_CLI_TASKS					0 // 1
#define mainCREATE_SIMPLE_UDP_CLIENT_SERVER_TASKS	0 // 1
#define mainCREATE_SELECT_UDP_SERVER_TASKS			0 /* _RB_ Requires retest. */
#define mainCREATE_UDP_ECHO_TASKS					0 // 1
#define mainCREATE_TCP_ECHO_TASKS_SINGLE			0 // 1
#define mainCREATE_TCP_ECHO_TASKS_SEPARATE			0 // 1
#define mainCREATE_SIMPLE_TCP_ECHO_SERVER			0 // 1
#define mainCREATE_FTP_SERVER						0 // 1
#define mainCREATE_HTTP_SERVER 						0 // 1
#define mainCREATE_TFTP_SERVER						0 // 1
...
void vApplicationIPNetworkEventHook(eIPCallbackEvent_t eNetworkEvent)
{
    ...
    if (eNetworkEvent == eNetworkUp)
    {
        ...
        if (xTasksAlreadyCreated == pdFALSE)
        {
            ...
            /* Start all runway detection related tasks */
...
#endif
            start_runway_detection(
                "RunwayDetection/EdgeDetectionTask/lena.bmp",
                "RunwayDetection/EdgeDetectionTask/filtered-lena.bmp",
                "RunwayDetection/DataEncryptionTask/unencrypted-lena.bmp",
                "RunwayDetection/DataEncryptionTask/decrypted-lena.bmp",
                167, // 167
                223, // 223
                "capstone"
